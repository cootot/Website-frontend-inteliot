...
export default function Admin() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    e.preventDefault();
    // TODO: Add logic to submit form data to the upcomingEvents database
  ...
  const handleProjectSubmit = (e: React.FormEvent) => {
    e.preventDefault();
    // TODO: Add logic to submit projectForm data to the projects database
  ...
  const handleTeamSubmit = (e: React.FormEvent) => {
    e.preventDefault();
    // TODO: Add logic to submit teamForm data to the team members database
    alert("Team member submitted! (DB integration pending)");
    setTeamForm({ name: "", role: "", bio: "", image: "", github: "", linkedin: "", email: "" });
  };

  return (
    <div className="flex flex-col md:flex-row items-center md:items-start md:justify-around gap-10 w-full md:px-12">
