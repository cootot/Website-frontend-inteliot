...
const timelineData = [
  {
    ...
    date: "7 FEB 2022",
    description: "Intel IoT Club’s first industrial training session on Intel DevCloud and Intel OpenVINO toolkit. Sandeep Rajakrishnan (ML Lead) addressed the development and deployment of deep learning models. Deepak Sai (Head) demonstrated a 'Safety Detection' project, highlighting the benefits of OpenVINO to optimize AI models and test their performance on Intel DevCloud.",
    image: "/timeline/event_1.png",
  },
  {
    title: "Blog-a-thon",
    date: "23 June 2022",
    description: "A technical blog competition on AI, ML, Deep Learning, and IoT with entries exceeding 800 words. Out of 30 contenders, 5 emerged victorious providing an excellent platform for students to showcase their writing and technical knowledge in AI and IoT.",
    image: "/timeline/event_2.png",
  },
  {
    title: "Breaking into AI",
    date: "21 MAY 2022",
    description: "The Intel IoT Club conducted its first offline event, 'Pie & AI - Amrita: Breaking into AI' with over 500 registrations and 300 attendees. Sessions covered AI, machine learning, and IoT use cases by speakers Deepak (Head), Prem Sundar (AI Lead), Mohan (IoT Lead), and Dr. Anbazhagan (Faculty Coordinator).",
    image: "/timeline/event_3.png",
  },
  {
    title: "Breaking into AIoT",
    date: "15 NOV 2022",
    description: "The seminar focused on IoT, AR, ML, and Intel technologies, attracting 600 registrations and over 400 attendees. Mr. Navaneeth Malingan (Founder, Nunnari Labs) shared insights on open source, competitive programming, and entrepreneurship.",
    image: "/timeline/event_4.png",
  },
  {
    title: "Edge AI and HATs of Raspberry Pi",
    date: "15 MAR 2023",
    description: "A webinar covering Edge AI and Raspberry Pi HATs, conducted by Mohan V (IoT Team Lead) and Deepak Sai (Head), discussed the benefits of Intel oneAPI and Edge AI applications.",
    image: "/timeline/event_5.png",
  },
  {
    title: "IoT Workshop - 'Build your smart home'",
    date: "23 APR 2023",
    description: "An IoT workshop where 7 smart home devices were built using Raspberry Pi 3 and Grove Pi kit. Mohan V and Yash Puthalath led the sessions with 50 attendees participating.",
    image: "/timeline/event_6.png",
  },
  {
    title: "IoT Competition",
    date: "19 AUG 2023",
    description: "IoT competition led by Mohan V featured projects based on grove pi kit. 20 applications were submitted; winning projects included a coal mine evacuation system and smart agriculture monitoring system.",
    image: "/timeline/event_7.png",
  },
  {
    title: "Intel IoT Club Induction - 2nd Batch",
    date: "2 FEB 2024",
    description: "Second induction event with 40 new members. Srinithi (IoT Lead) and Balasuriya (AI/ML Lead) discussed IoT/AI trends. Live demo of entry count system was showcased to 200 attendees.",
